"""
Django settings for retail_api project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-bf&@2g!mj6(r4m*njnv^1$h8t8sj(*p8l%5^n)#e+h$f!0&1n6')
...
WSGI_APPLICATION = 'retail_api.wsgi.application'
